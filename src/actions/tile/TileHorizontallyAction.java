...
public class TileHorizontallyAction extends AbstractAction {
	...
	public TileHorizontallyAction() {
		...
		putValue(SMALL_ICON, loadIcon("images/tileHorizontally.png"));
		putValue(AbstractAction.NAME, Localization.getInstance().getBundle().getString("tilehorizontally"));
		putValue(SHORT_DESCRIPTION, Localization.getInstance().getBundle().getString("tilehorizontally"));
