...
public class ToCircleState extends AbstractAction {

	public ToCircleState() {
		putValue(NAME, "Circle");
		putValue(SMALL_ICON, loadIcon("images/circle.png"));
		putValue(SHORT_DESCRIPTION, Localization.getInstance().getBundle().getString("circle"));
	}
