...
public class RotateSelectedRight extends AbstractAction {

	public RotateSelectedRight() {
		putValue(SMALL_ICON, loadIcon("images/rotateRight.png"));
		putValue(SHORT_DESCRIPTION, Localization.getInstance().getBundle().getString("rotateRight"));
		putValue(AbstractAction.NAME, Localization.getInstance().getBundle().getString("rotateRight"));
	}
