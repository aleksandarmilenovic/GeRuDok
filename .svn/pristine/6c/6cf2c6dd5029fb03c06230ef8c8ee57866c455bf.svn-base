...
public class ToRectangleState extends AbstractAction {

	public ToRectangleState() {
		putValue(NAME, "Rectangle");
		putValue(SMALL_ICON, loadIcon("images/rectangle.png"));
		putValue(SHORT_DESCRIPTION, Localization.getInstance().getBundle().getString("rectangle"));
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (node instanceof SlotGM) {
			((SlotGM) node).startRectangleState();
		}
	}
